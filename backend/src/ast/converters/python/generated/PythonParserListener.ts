...
export default class PythonParserListener extends ParseTreeListener {
   ...
   * @param ctx the parse tree
   */
  enterParam_no_default_star_annotation?: (
   ...
   * @param ctx the parse tree
   */
  exitParam_no_default_star_annotation?: (
    ctx: Param_no_default_star_annotationContext,
  ) => void;
  /**
   ...
   * @param ctx the parse tree
   */
  enterType_param_starred_default?: (
   ...
   * @param ctx the parse tree
   */
  exitType_param_starred_default?: (
    ctx: Type_param_starred_defaultContext,
  ) => void;
  /**
  ...
  enterCompare_op_bitwise_or_pair?: (
    ctx: Compare_op_bitwise_or_pairContext,
  ) => void;
  /**
   ...
   * @param ctx the parse tree
   */
  enterFstring_replacement_field?: (
