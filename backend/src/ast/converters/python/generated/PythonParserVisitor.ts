 ...
 */
export default class PythonParserVisitor<
  Result,
> extends ParseTreeVisitor<Result> {
   ...
   * @return the visitor result
   */
  visitParam_no_default_star_annotation?: (
   ...
   * @return the visitor result
   */
  visitType_param_starred_default?: (
   ...
   * @return the visitor result
   */
  visitFstring_replacement_field?: (
