...
export class TaskFormReferenceSolutionsPageModel extends TaskFormPageModel {
  ...
  private get referenceSolutionsList(): Locator {
    return this.form.getByTestId("reference-solutions");
  }

  private get addReferenceSolutionButton(): Locator {
    return this.form.getByRole("button", { name: /add reference solution/i });
  }

  private getEditSolutionButton(solutionId: number): Locator {
  ...
  private async getAllSolutionsIds(): Promise<number[]> {
