...
import { FunctionDeclarationGroupCriterion } from ".";

type FormValues = Omit<FunctionDeclarationGroupCriterion, "criterion">;
...
> = ({ submitMessage, onUpdate, initialValues }) => {
  ...
  return (
    <form
      ...
      data-testid="function-declaration-group-form"
    >
      <Controller
        name="granularity"
        control={control}
