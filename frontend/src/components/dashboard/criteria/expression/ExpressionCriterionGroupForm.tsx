...
import { ExpressionGroupCriterion } from ".";

type FormValues = Omit<ExpressionGroupCriterion, "criterion">;

const messages = defineMessages({
  granularity: {
    id: "ExpressionCriterionGroupForm.granularity",
    defaultMessage: "Granularity",
  },
});

const ExpressionCriterionGroupForm: CriterionFormComponent<
...
> = ({ submitMessage, onUpdate, initialValues }) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} data-testid="expression-group-form">
      <Controller
        name="granularity"
        control={control}
        render={({ field }) => (
...
export default ExpressionCriterionGroupForm;
