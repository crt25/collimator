...
import { StatementGroupCriterion } from ".";

type FormValues = Omit<StatementGroupCriterion, "criterion">;

const messages = defineMessages({
  granularity: {
    id: "StatementCriterionGroupForm.granularity",
    defaultMessage: "Granularity",
  },
});

const StatementCriterionGroupForm: CriterionFormComponent<
...
> = ({ submitMessage, onUpdate, initialValues }) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} data-testid="statement-group-form">
      <Controller
        name="granularity"
        control={control}
        render={({ field }) => (
...
export default StatementCriterionGroupForm;
